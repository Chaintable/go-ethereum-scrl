...
var (
	...
	allowedFutureBlockTimeSeconds = int64(15 * 1000)  // Max milliseconds from current time allowed for blocks, before they're considered future blocks (previously 15 seconds)
...
func (ethash *Ethash) VerifyHeader(chain consensus.ChainHeaderReader, header *types.Header, seal bool) error {
	...
	return ethash.verifyHeader(chain, header, parent, false, seal, time.Now().UnixMilli())
}
